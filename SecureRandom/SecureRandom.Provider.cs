...
#pragma warning restore IDE0180
        ...
        /// <summary>
        /// Random value from the <see cref="enum"/>.
        /// </summary>
        public TSource NextEnum<TSource>() where TSource : Enum
        {
            var values = Enum.GetValues(typeof(TSource));
            return (TSource)values.GetValue(Next(values.Length))!;
        }
